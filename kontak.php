...
?>
    ...
    <div class="w3-modal" style="display: none;" id="contactAdd">
        <form action="contactAdd.php" method="post" style="margin: 30px 500px; background-color: white; padding: 30px;">
            <button class="cancel w3-btn w3-cyan" onclick="document.getElementById('contactAdd').style.display='none'">X</button>
            ...
            <input type="submit" value="Submit" name="addSubmit" class="w3-btn w3-cyan" style="margin-top: 20px;"></center>
        </form>
    </div>
    ...
    <div class="w3-modal" style="display: none;" id="contactEdit">
        <form action="contactEdit.php" method="post" style="margin: 30px 500px; background-color: white; padding: 30px;">
            <button class="cancel w3-btn w3-cyan" onclick="document.getElementById('contactEdit').style.display='none'">X</button>
            ...
            <input type="submit" value="Submit" name="addSubmit" onclick="editContact()" class="w3-btn w3-cyan" style="margin-top: 20px;"></center>
        </form>
    </div>

<div class="isi">
<button class="w3-btn w3-cyan" style="margin-bottom: 20px" onclick="addContactForm()">Tambah Alamat</button>
<center>
