...
--
-- Host: localhost:3306
-- Generation Time: Aug 17, 2018 at 11:16 AM
...
('willychai04@gmail.com', 'fjijiasd', 0, NULL, NULL);
...
--
ALTER TABLE `category`
  MODIFY `idCategory` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `trolli`
  MODIFY `idTrolli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
